...
Xtrain_path = "hf://datasets/debasishdas1985/tourism-package-predictor/Xtrain.csv"
Xtest_path = "hf://datasets/debasishdas1985/tourism-package-predictor/Xtest.csv"
ytrain_path = "hf://datasets/debasishdas1985/tourism-package-predictor/ytrain.csv"
ytest_path = "hf://datasets/debasishdas1985/tourism-package-predictor/ytest.csv"
...
numeric_features = [
    'Age',                        # Customer's age
    'CityTier',                   # City category based on development
    'PreferredPropertyStar',      # Preferred hotel rating
    'NumberOfPersonVisiting',     # Total number of people on trip
    ...
    'PitchSatisfactionScore',     # Satisfaction with sales pitch
...
print(f"Class weight calculated: {class_weight}")
...
with mlflow.start_run():
    ...
    repo_id = "debasishdas1985/tourism-package-predictor-model"
    repo_type = "model"
